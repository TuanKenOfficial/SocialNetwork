    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(StoryActivity.this,FollowsActivity.class);
    ...
    private void userInfo(String userid){
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Picasso.get().load(user.getProfileimage()).placeholder(R.drawable.users).into(story_photo); //hổ trợ hình ảnh
